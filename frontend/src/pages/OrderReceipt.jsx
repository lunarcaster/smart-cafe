...
//       <h1 className="great-vibes-regular text-3xl font-bold mb-2">La Lunarcaster Cafe</h1>
      
//   {/* Pesan pembayaran */}
//   <p className="mb-6 text-[#3E2C24] italic">{paymentMessage}</p>

//       <div className="w-full max-w-md bg-white p-6 rounded-lg shadow-md">
//         {cart.map((item, idx) => (
//           <div
//             key={idx}
//             className="flex justify-between mb-3 text-[#3E2C24]"
//           >
//             <span>
...
//         <p className="mt-4">Payment Method: {paymentMethod}</p>
